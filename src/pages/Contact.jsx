  ...
  return (
    <div className="px-2 py-4 flex flex-col justify-center items-center font-sans">
      ...
      <div className="md:flex md:gap-16">
        <div className="mt-5 md:mt-0 md:basis-1/2 grow shrink-0">
          <form name="contact" method="POST">
            <input type="hidden" name="form-name" value="contact" />
            <div className="shadow-lg rounded-md overflow-hidden">
              <div className="px-4 py-4 bg-slate-300/50 dark:bg-slate-600/75 space-y-6 sm:p-6">
              ...
              <div className="px-4 py-4 bg-slate-300/50 dark:bg-slate-600/75 text-right sm:px-6">
                <button
                  type="submit"
            ...
            <div className="flex flex-wrap justify-center gap-x-2">
              ...
              >
                <div className="relative group py-4 my-4 px-4 flex justify-left items-center bg-slate-300/50 dark:bg-slate-600/75 shadow-lg rounded-md border border-white/5 hover:ring-1 hover:ring-emerald-500 hover:-translate-y-1 transition ease-in-out">
                  <svg
                    ...
                    height="48"
                    viewBox="0 0 24 24"
                    className="fill-slate-900 dark:fill-slate-300 shrink-0"
                  >
              ...
              >
                <div className="relative group py-4 my-4 px-4 flex justify-left items-center bg-slate-300/50 dark:bg-slate-600/75 shadow-lg rounded-md border border-white/5 hover:ring-1 hover:ring-emerald-500 hover:-translate-y-1 transition ease-in-out">
                  ...
                  <p className="text-lg ml-4 whitespace-nowrap">
                    /cameron-mackenzie1999
                  </p>
                  <svg
                    width="18"
                    height="18"
