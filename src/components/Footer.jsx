    ...
    <div className="flex justify-center items-center sticky top-[100vh] border-t border-slate-700/20 dark:border-slate-300/10 md:w-1/2 mx-4 md:mx-auto gap-6">
      ...
      <div className="flex flex-wrap -mx-4 overflow-hidden">
        <a
          ...
          target="_blank"
          className="my-4 px-4 w-1/2 overflow-hidden group hover:-translate-y-1 transition ease-in-out"
        >
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
            className="fill-slate-900 dark:fill-slate-300 group-hover:fill-emerald-500"
          >
